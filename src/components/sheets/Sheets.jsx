...
const TABLE_SCHEMAS = {
  'PO Data': ['Sr.No', 'Ref', 'PO Date', 'Status', 'Project', 'Supplier', 'Net Price', 'VAT', 'Total Price', 'Month'],
  'material_detail_25': ['PR', 'Sr_No', 'Project', 'Description', 'change1_rate', 'change1_total', 'change1_supplier', 'change2_rate', 'change2_total', 'change2_supplier'],
